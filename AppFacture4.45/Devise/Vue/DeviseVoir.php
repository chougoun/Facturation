...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <h1 class="text-light">Devise Voir</h1>
        <?php
      ...
      <div class="form-group">
        ...
        <p>Taux : </p><input class="form-control" type="text" name="encours" value="<?php echo $_SESSION['taux'] ?>" size="20" maxlength="30" readonly><BR>
        <a href="DeviseLister.php"><button class="btn btn-dark">Retour</button></a>
    </div>
</div>
