...
<head>
    ...
    <title>Création d'une devise</title>
...
<body class="bg-secondary">
    ...
    <h1 class="text-light">Devise Créer</h1>
    <?php
...
<div class="form-group">
    <form action="../controller/DeviseCreerAccept.php" method="POST">
        <p>ID devise: </p><input class="form-control" type="text" name="devId" value="" size="3" maxlength="3"><BR>
        <p>Nom Devise : </p><input class="form-control" type="text" name="nom" value="" size="20" maxlength="30"><BR>
        <p>Taux de Change : </p><input class="form-control" type="text" name="taux" value="" size="20" maxlength="30"><BR>
