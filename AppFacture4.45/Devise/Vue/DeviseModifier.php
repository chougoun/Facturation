...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <h1 class="text-light">Devise Modifier</h1>
        <?php
        ...
        $devIdErr = $_SESSION['devIdErr'];
        $nomErr = $_SESSION['nomErr'];
        $tauxErr = $_SESSION['tauxErr'];
        ?>
        <div class="erreur"><?php echo $txtErreur; ?></div>
        <div class="erreur"><?php echo $devIdErr; ?></div>
        <div class="erreur"><?php echo $nomErr; ?></div>
        <div class="erreur"><?php echo $tauxErr; ?></div>
        <div class="form-group">
            <form action="../controller/DeviseModifierAccept.php" method="POST">
                <p>ID Devise : </p><input class="form-control" type="text" name="devId" value="<?php echo $_SESSION['id'] ?>" size="3" maxlength="3" readonly ><BR>
                <p>Nom Devise : </p><input class="form-control" type="text" name="nom" value="<?php echo $_SESSION['nom'] ?>" size="20" maxlength="30"><BR>
                <p>Le Taux de Change : </p><input class="form-control" type="text" name="taux" value="<?php echo $_SESSION['taux'] ?>" size="20" maxlength="30"><BR>
