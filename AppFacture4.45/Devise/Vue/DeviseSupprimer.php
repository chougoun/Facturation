...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <h1 class="text-light">Devise Supprimer</h1>
        <?php
      ...
      ?>
      <div><?php echo $txtErreur; ?></div>
      <div class="form-group">
        <form action="../controller/DeviseSupprimerAccept.php" method="POST">
            <p>ID Devise : </p><input class="form-control" type="text" name="devId" value="<?php echo $_SESSION['id'] ?>" size="20" maxlength="20" readonly ><BR>
            <p>Nom Devise : </p><input class="form-control" type="text" name="nom" value="<?php echo $_SESSION['nom'] ?>" size="20" maxlength="30" readonly><BR>
            <p>Le Taux de Change : </p><input class="form-control" type="text" name="taux" value="<?php echo $_SESSION['taux'] ?>" size="20" maxlength="30" readonly><BR>
            <a href="../controller/DeviseSupprimerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
            <a href="../controller/DeviseListerInit.php"><button class="btn btn-light" type="button" value="Annuler">Annuler</button></a>
        </form>
    </div>
</div>
