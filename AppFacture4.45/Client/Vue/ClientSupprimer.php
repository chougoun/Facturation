...
?>
    ...
    <h1 class="text-light">Client Supprimer</h1>
    <div class="form-group">
        <form action="../controller/ClientSupprimerAccept.php" method="POST">
            <p>ID Client : </p><input class="form-control" type="text" name="Id_client" value="<?php echo $idClient ; ?>" size="20" maxlength="20" readonly readonly><BR>
            ...
            <a href="../controller/ClientSupprimerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
