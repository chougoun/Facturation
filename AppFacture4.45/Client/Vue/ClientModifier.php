...
<body class="bg-secondary">
   ...
   <div class="erreur"><?php echo $idDeviseErr; ?></div>
    <h1 class="text-light">Client Modifier</h1>
    <div class="form-group">
        <form action="../controller/ClientModifierAccept.php" method="POST">
            <p>ID Client : </p><input class="form-control" type="text" name="Id_client" value="<?php echo $idClient ; ?>" size="20" maxlength="20" readonly ><BR>
            <p>Nom : </p><input class="form-control"  type="text" name="Nom" value="<?php echo $nom ; ?>" size="20" maxlength="30"><BR>
            <p>Prenom : </p><input class="form-control" type="text" name="Prenom" value="<?php echo $prenom ; ?>" size="20" maxlength="30"><BR>
            <p>Telephone : </p><input class="form-control" type="text" name="Telephone" value="<?php echo $telephone; ?>" size="20" maxlength="20"><BR>
            <p>Courriel : </p><input class="form-control" type="text" name="Courriel" value="<?php echo $courriel; ?>" size="20" maxlength="60"><BR>
            <p>Societe : </p><input class="form-control" type="text" name="Societe" value="<?php echo $societe; ?>" size="20" maxlength="50"><BR>
            <p>Adresse : </p><input class="form-control" type="text" name="Adresse" value="<?php echo $adresse; ?>" size="20" maxlength="50"><BR>
            <p>Ville : </p><input class="form-control" type="text" name="Ville" value="<?php echo $ville; ?>" size="20" maxlength="30"><BR>
            <p>Code Postal: </p><input class="form-control" type="text" name="Code_postal" value="<?php echo $codePostal; ?>" size="20" maxlength="5"><BR>
            <p>Pays : </p><input class="form-control" type="text" name="Pays" value="<?php echo $pays; ?>" size="20" maxlength="25"><BR>
            ...
            <a href="../controller/ClientCreerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
