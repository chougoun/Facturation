...
<head>
    ...
    <title>Application Facturation</title>
...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h1 class="text-light" style="text-align: center;">Application de facturation</h1>
            <div class="line"></div>
            <center>
                <img src="img/fond.png" class="img-fluid w-50 p-3" alt="Responsive image">
            </center>
            <div class="line"></div>
            <p>Entreprise FunBiz</p> 
        </div>
    </div>
