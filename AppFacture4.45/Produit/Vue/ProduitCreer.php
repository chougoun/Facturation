...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <h1 class="text-light">Produit Créer</h1>
        <?php
    ...
    <div class="form-group">
        <form action="../controller/ProduitCreerAccept.php" method="POST">
            <p>Id du Produit : </p><input class="form-control" type="text" name="id" value="" size="20" maxlength="3" readonly><BR>
            <p>Prix du Produit : </p><input class="form-control" type="text" name="prix" value="" size="20" maxlength="20"><BR>
            <p>Nom du produit : </p><input class="form-control" type="text" name="nom" value="" size="20" maxlength="30"><BR>
            <p>ID Sous Famille : </p>
            <select class="form-control" name="idSFA"> 
                <?php
                $conn = connexionDB();
                $query = "SELECT * FROM sous_famille";
                $resultat = mysqli_query($conn, $query );
                $i = 0;
                while ( $i < $resultat->num_rows ) {
                  $row = mysqli_fetch_assoc($resultat);
                  $res = $row['sfa_id_sous_famille'];
                  $nom = $row['sfa_nom_sous_famille'];
