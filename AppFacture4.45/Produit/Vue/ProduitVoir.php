...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        <h1 class="text-light">Produit Voir</h1>
        <?php
      ...
      <div class="form-group">
        <p>ID Produit : </p><input class="form-control" type="text" name="id" value="<?php echo $_SESSION['id'] ?>" size="20" maxlength="20" readonly ><BR>
        <p>Prix : </p><input class="form-control" type="text" name="prix" value="<?php echo $_SESSION['prix'] ?>" size="20" maxlength="20" readonly ><BR>
        <p>Nom : </p><input class="form-control" type="text" name="nom" value="<?php echo $_SESSION['nom'] ?>" size="20" maxlength="30" readonly><BR>
        ...
        <a href="ProduitLister.php"><button class="btn btn-dark">Retour</button></a>
    </div>
</div>
