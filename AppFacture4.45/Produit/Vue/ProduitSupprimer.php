...
<body class="bg-secondary">
    <div class="wrapper">
        ...
        if ( $txtErreur == "" ) {
          ...
          $txtErreur = $_SESSION['erreur'];
          $proId = $_SESSION['id'];
          $proPrix = $_SESSION['prix'];
          $proNom = $_SESSION['nom'];
          $proIdSFA = $_SESSION['idSFA'];	  
      }
      ?>
      <div class="form-group">
        <form action="../controller/ProduitSupprimerAccept.php" method="POST">
            <p>Id du Produit : </p><input class="form-control" type="text" name="id" value="<?php echo $_SESSION['id']?>" size="20" maxlength="20" readonly><BR>
            <p>Prix du Produit : </p><input class="form-control" type="text" name="prix" value="<?php echo $_SESSION['prix']?>" size="20" maxlength="20" readonly><BR>
            <p>Nom du produit : </p><input class="form-control" type="text" name="nom" value="<?php echo $_SESSION['nom']?>" size="20" maxlength="30" readonly><BR>
            ...
            <a href="../controller/ProduitSupprimerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
            <a href="ProduitLister.php"><button class="btn btn-light" type="button" value="Annuler">Annuler</button></a>
        </form>
    </div>
</div>
