...
<form action="../controller/LigneFactureSupprimerAccept.php" method="POST">
    <div class="form-group">
        <p>ID de la Ligne Facture: </p><input class="form-control" type="text" name="lfa_id_ligne_facture" value="<?php echo $lfaIdLigneFacture ; ?>" size="20" maxlength="20" readonly><BR>
        <p>Quantite : </p><input class="form-control" type="text" name="lfa_quantite" value="<?php echo $lfaQuantite ; ?>" size="20" maxlength="30" readonly><BR>
        ...
        <p>ID de la Ligne Facture  : </p><input class="form-control" type="text" name="lfa_id_facture" value="<?php echo $lfaIdFacture ; ?>" size="20" maxlength="20" readonly><BR>
        ...
        <a href="../controller/LigneFactureSupprimerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
