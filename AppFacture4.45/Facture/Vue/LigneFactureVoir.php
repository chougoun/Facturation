...
<h1 class="text-light">Voir Ligne Facture</h1>
<form>
    <div class="form-group">
        <p>ID Ligne Facture  : </p><input class="form-control" type="text" name="lfa_id_ligne_facture" value="<?php echo $lfaIdLigneFacture ; ?>" size="20" maxlength="20"readonly="readonly"><BR>
        <p>Quantité : </p><input class="form-control" type="text" name="lfa_quantite" value="<?php echo $lfaQuantite ; ?>" size="20" maxlength="30" readonly="readonly"><BR>
        <p>Prix Unitaire : </p><input class="form-control" type="text" name="lfa_prix_unitaire_facture" value="<?php echo $lfaPrixUnitaireFacture ; ?>" size="20" maxlength="30" readonly="readonly"><BR>
        <p>ID Facture : </p><input class="form-control" type="text" name="lfa_id_facture" value="<?php echo $lfaIdFacture; ?>" size="20" maxlength="20" readonly="readonly"><BR>
        <p>ID Produit : </p><input class="form-control" type="text" name="lfa_id_produit" value="<?php echo $lfaIdProduit; ?>" size="20" maxlength="60" readonly="readonly"><BR>
    </div>
</form>
<a href="../vue/LigneFactureLister.php"><button class="btn btn-dark">Retour</button></a>
</div>
