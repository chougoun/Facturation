...
<body class="bg-secondary">
    ...
    <h1 class="text-light">Création d'une Famille</h1>
    <?php
 ...
 <div class="form-group">
    <form action="../controller/FamilleCreerAccept.php" method="POST">
        <p>ID Famille : </p><input class="form-control" type="text" name="fam_id_famille" value="<?php echo $famIdFamille ; ?>" size="20" maxlength="3" readonly><BR>
        <p>Nom Famille : </p><input class="form-control" type="text" name="fam_nom_famille" value="<?php echo $famNomFamille ; ?>" size="20" maxlength="40"><BR>
