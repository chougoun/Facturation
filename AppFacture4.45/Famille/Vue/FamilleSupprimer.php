...
<body class="bg-secondary">
    ...
    <h1 class="text-light">Suppression d'une Famille</h1>
    <div class="form-group">
        <form action="../controller/FamilleSupprimerAccept.php" method="POST">
            ...
            <p>Nom Famille : </p><input class="form-control" type="text" name="fam_nom_famille" value="<?php echo $famNomFamille ; ?>" size="20" maxlength="30"readonly="readonly"><BR>
            <a href="../controller/FamilleSupprimerAccept.php"><button class="btn btn-dark" type="submit" name="Valider" value="Valider">Valider</button></a>
